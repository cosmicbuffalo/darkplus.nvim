...
M.base = {
  ...
  FoldColumn = { fg = c.accent, bg = c.darker },
  ...
  Normal = { fg = c.fg, bg = config.transparent_background and 'NONE' or c.darker },
  NormalFloat = { bg = c.darker },
  NormalNC = { fg = c.fg, bg = config.transparent_background and 'NONE' or c.darker},
  Number = { fg = c.orange },
  ...
  Typedef = { fg = c.purple },
  Variable = { fg = c.cyan },
  VertSplit = { fg = c.dark, bg = c.bg },
  Visual = { bg = c.ui_blue },
  VisualNOS = { bg = c.dark },
  WarningMsg = { fg = c.error_red, bg = c.dark },
...
M.plugins = {
  ...
  NvimTreeVertSplit = { fg = c.dark_gray, bg = c.darker },
  -- Neo-tree
  -- NeoTreeBufferNumber = {},
  ...
  -- NeoTreeVertSplit = {},
  -- NeoTreeWinSeparator = { bg = c.darker },
  -- NeoTreeEndOfBuffer = {},
  -- NeoTreeRootName = {},
